...
Mobile.takeScreenshotAsCheckpoint('Book the movie', FailureHandling.STOP_ON_FAILURE)

'Click Back button'
Mobile.tap(findTestObject('View Movie Info/Book the movie - back button'), 0)
